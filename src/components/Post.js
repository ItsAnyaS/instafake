...
const Post = ({user, content, caption, likes, comments, id}) => {
...
return (
  <div className="post">
    ...
    <div className="actions">
      ...
      ></ion-icon>
      <ion-icon name="chatbubbles-outline" class="comment-btn"></ion-icon>
    ...
    <div className="commentSection">
      {commentsIsShown &&
        comments.map((comment) => {
          return <PostComments comment={comment} key={comment.id} postId={postId}/>;
        })}
      <p
        onClick={() => {
